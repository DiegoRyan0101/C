...
Basicamente, a função strftime() converte o tempo armazenado em uma estrutura tm para string. Como a função printf(), essa também possui um conjunto de especificadores de tipo de saída para formatar o valor da data e hora de acordo com a informação que desejamos exibir.
 A Tabela 1.1 apresenta os especificadores que podem ser usados com essa função. Note que os especificadores cuja descrição está marcada com asterisco (*) são dependentes da configuração de localidade, ou seja, podem ser modificados para imprimir seus valores de acordo com a configuração usada no computador.
 ...
 %c            |Representação da data-hora*             |thu aug 23 14:55:02 2001
 %d            |Dia do mês(01-31)                       |23
 %H            |Hora formato 24h(00-23)                 |14
 %I            |Hora no formato 12h(01-12)              |02
 %j            |Dia do ano(001-366)                     |235
 %m            |Mês como valor inteiro(01-12)           |08
 %M            |Minuto(00-59)                           |55
 %p            |Designação AM ou PM                     |PM
 %S            |Segundo(00-61)                          |02
 %U            |Número da semana com a primeira segunda-feira como o primeiro dia da semana um (00-53)| 33
 %w            |Dia da semana como um valor inteiro com domingo como 0(0-6) | 4
 %W            |Número da semana com a primeira segunda-feira como o primeiro dia da semana um (00-53)| 34
 %x            |Representação da data* |08/23/01
 %X            |Representação da hora* |14:55:02
 %y            |Ano, dois últimos dígitos(00-99) | 01
 %Y            |Ano | 2002
 %z            |Nome do fuso horário ou abreviação | CDT
 %%            |Símbolo % | %
*/
